...
//         const usdc = await StandardToken.deploy("USDC", "USDC", 100000000000000, hot.target, warm.target);    
...
//         return {usr, nft, treasury, factory, hot, warm, cf, usdt, usdc, weth, view};
//     }

//     async function addLiquidityETH(warm:any, factory:any, usr:any, token0:any, token1:any, amount0:any, amount1:any, poolType:any, fee:any){
//         console.log("\n===== ===== ===== ===== addLiquidity ===== ===== ===== =====\n")
//         console.log("BlockNumber:",await hre.ethers.provider.getBlockNumber());

//         const addLiquidityETHTypes = ["uint256", "uint256", "uint256","uint8"];
//         const addLiquidityETHValues = [amount0, 1, 1, fee];
//         const addLiquidityETHEncode = hre.ethers.AbiCoder.defaultAbiCoder().encode(addLiquidityETHTypes, addLiquidityETHValues);
...
//         await warm.addLiquidityETH(token0,addLiquidityETHEncode,usr[0],99999999999999,fee,{
...
//           const {usr, nft, treasury, factory, hot, warm, cf, usdt, usdc,  weth, view} = await loadFixture(deploy);
...
//           console.log("\n===== ===== ===== ===== ===== ===== ===== ===== ===== =====\n")
//         //   cf:                  0x322813Fd9A801c5507c9de605d63CEA4f2CE6c44
//         //   usdt:                0xa85233C63b9Ee964Add6F2cffe00Fd84eb32338f
...
//         // cf & weth
//         it("Should successfully all (no fee/no eth) weth", async function(){
//             const {usr, nft, treasury, factory, hot, warm, cf, usdt, usdc, weth, view} = await loadFixture(deploy);
            
//             console.log("\n===== ===== ===== ===== ===== ===== ===== ===== ===== =====\n")

//             console.log("test normal pool weth")
//             await addLiquidityETH(warm, factory, usr[0], cf, weth,200000000000000000000000n,25000000000000000000000n,2,3);

//             // let poolType_ = 2;

//             // if(BigInt(cf.target) > BigInt(weth.target)){
//             //     if(poolType_ === 2){
//             //         poolType_ = 3;
//             //     }else if(poolType_ === 4){
//             //         poolType_ = 5;
...
//             // await swapExactTFT(nft,treasury,hot,factory,usr,1000000000000000000n,[cf, weth],[poolType_],[3])
//             // await swapExactTFT(nft,treasury,hot,factory,usr,1000000000000000000n,[weth, cf],[poolType_],[3])          
//             // await swapTFExactT(nft,treasury,hot,factory,usr,1000000000000000000n,[cf, weth],[poolType_],[3])
//             // await swapTFExactT(nft,treasury,hot,factory,usr,1000000000000000000n,[weth, cf],[poolType_],[3])     

//             // await swapExactTFTSupportFeeOn(nft,treasury,hot,factory,usr,1000000000000000000n,[cf, weth],[poolType_],[3])
//             // await swapExactTFTSupportFeeOn(nft,treasury,hot,factory,usr,1000000000000000000n,[weth, cf],[poolType_],[3])             

//             // await removeLiquidity(warm,factory,usr,cf,weth,
//             //     await (await hre.ethers.getContractAt("CoinfairPair",(await factory.getPair(cf, weth, poolType_, 3))))
//             //         .balanceOf(usr[0]),poolType_,3)

//             // // ========================================================================
//             // console.log("test pool 1, 10 without roolover")
//             // await addLiquidity(warm,factory,usr,cf,weth,200000000000000000000000n,25000000000000000000000n,1,10);
//             // const pair110 = await factory.getPair(cf, weth, 1, 10);
...
//             // await swapExactTFT(nft,treasury,hot,factory,usr,1000000000000000000n,[cf, weth],[1],[10])
//             // await swapExactTFTSupportFeeOn(nft,treasury,hot,factory,usr,1000000000000000000n,[cf, weth],[1],[10])
...
//             // await swapExactTFT(nft,treasury,hot,factory,usr,1000000000000000000n,[weth, cf],[1],[10])
//             // await swapExactTFTSupportFeeOn(nft,treasury,hot,factory,usr,1000000000000000000n,[weth, cf],[1],[10])
//             // await treasury.setRoolOver(pairContract110.target,true);
...
//             // await swapTFExactT(nft,treasury,hot,factory,usr,1000000000000000000n,[cf, weth],[1],[10])
//             // await treasury.setRoolOver(pairContract110.target,true);
...
//             // await swapTFExactT(nft,treasury,hot,factory,usr,1000000000000000000n,[weth, cf],[1],[10])
//             // await treasury.setRoolOver(pairContract110.target,true);
//             // console.log("test pool 1, 10 and roolover 4")
//             // await swapTFExactT(nft,treasury,hot,factory,usr,1000000000000000000n,[weth, cf],[1],[10])       

//             // await removeLiquidity(warm,factory,usr,cf,weth,
//             //     await (await hre.ethers.getContractAt("CoinfairPair",(await factory.getPair(cf, weth, 1, 10))))
